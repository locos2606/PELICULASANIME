...
<body>
    <div class="banner">
        <img src="Assets/diseno-logotipo-anime-dibujado-mano_23-2151269668.avif" id="banner-image" alt="Banner Manga">
    </div>


    <!--logo de ir atras-->
    <a class="logo-back" href="{{ route('sesion_iniciada') }}"><img src="{{ asset('Assets/diseno-logotipo-anime-dibujado-mano_23-2151269668.avif') }}" alt=""></a>
    ...
    <div class="container">
        ...
        <img src="/Assets/diseno-logotipo-anime-dibujado-mano_23-2151269668.avif" id="manga-cover" data-url="https://mangadex.org/covers/{{ $manga->id }}/{{ $coverArt->attributes->fileName }}" alt="Portada de {{ $manga->attributes->title->en ?? 'sin título' }}">
        @else
