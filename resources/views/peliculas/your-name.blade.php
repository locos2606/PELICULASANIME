...
<body>
    ...
    <main>
        <section id="anime-info">
            <h2>YOUR NAME</h2>
            <img src="https://m.media-amazon.com/images/M/MV5BZmUyYWRiODktOGYxMC00MWY3LThhNDUtZTViZDVkYTYwYmJhXkEyXkFqcGc@._V1_QL75_UY281_CR10,0,190,281_.jpg" alt="YOUR NAME" loading="lazy">
            <p>"Your Name" cuenta la historia de Mitsuha y Taki, dos adolescentes que descubren que están misteriosamente conectados: despiertan ocasionalmente en el cuerpo del otro. A medida que intentan comunicarse y adaptarse, surge entre ellos un vínculo profundo que trasciende el tiempo y el espacio.</p>

            <div id="anime-player">
                <h3>Reproductor de Episodios</h3>
                <iframe width="640" height="480" src="https://drive.google.com/file/d/1tMc8MoZo1gHrFEOj9UmiVUV9Q07MEwvc/preview" 
                        frameborder="0" allow="autoplay" allowfullscreen loading="lazy"></iframe>
            </div>
        </section>

        <button id="saveMangaButton" data-manga-title="YOUR NAME">
    ...
    @livewire('comment-component', ['mangaId' => 10])
