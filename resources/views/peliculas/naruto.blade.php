    ...
    <section id="anime-info" class="bg-gray-800 rounded-2xl shadow-lg overflow-hidden">
      <div class="md:flex">
        ...
        <div class="md:w-2/3 p-6 flex flex-col justify-between">
          <div>
            <h2 class="text-3xl font-bold mb-4">Naruto</h2>
            <p class="text-gray-300 mb-6">
              Naruto Uzumaki es un joven ninja que busca el reconocimiento de su aldea y sueña con convertirse en el <span class="text-green-400 font-semibold">Hokage</span>.
            </p>
