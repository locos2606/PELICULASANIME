...
<body>
    ...
    <main>
        <section id="anime-info">
            <h2>Parasyte</h2>
            <img src="https://m.media-amazon.com/images/M/MV5BMzg2YjA0NGYtYjQwMS00MDQyLWFlNWMtODVhNTBkYWIyNjE1XkEyXkFqcGc@._V1_FMjpg_UX1000_.jpg" 
                 alt="Parasyte" loading="lazy">
            
            <p>Shinichi Izumi es un adolescente normal hasta que unos organismos invaden la Tierra. Se trata de gusanos (parásitos) que se introducen dentro de los humanos a través de sus ojos o nariz, con el objetivo de dominar su cerebro.</p>

            <div id="anime-player">
                <h3>Reproductor de Episodios</h3>
                <iframe width="640" height="480" 
                        src="https://drive.google.com/file/d/1NjdPho2sZNG2fjsw03czS3qJELYrEbPV/preview" 
                        frameborder="0" allow="autoplay" allowfullscreen loading="lazy">
                </iframe>
            </div>

            <!-- Botón para agregar a favoritos -->
            <button id="saveMangaButton" data-manga-title="parasyte">
        ...
        @livewire('comment-component', ['mangaId' => 4])
    </main>
