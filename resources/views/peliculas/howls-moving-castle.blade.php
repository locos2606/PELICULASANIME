...
<head>
    ...
    <title>HOWL'S MOVING CASTLE - ANIMEDJ</title>
...
<body>
    ...
    <main>
        <section id="anime-info">
            ...
            <img src="https://upload.wikimedia.org/wikipedia/en/a/a0/Howls-moving-castleposter.jpg" alt="HOWL'S MOVING CASTLE" loading="lazy">
            <p>"Howl's Moving Castle" cuenta la historia de Sophie, una joven que es transformada en una anciana por una bruja. En su viaje para romper el hechizo, conoce al misterioso mago Howl y se embarca en una aventura llena de magia, guerra y descubrimiento personal.</p>

            <div id="anime-player">
                <h3>Reproductor de Episodios</h3>
                <iframe width="640" height="480" src="https://drive.google.com/file/d/1vgAaPWWE-AoZ9-j-6wAyipDRY7vkaqkz/preview" 
                        frameborder="0" allow="autoplay" allowfullscreen loading="lazy"></iframe>
            </div>
        </section>

        <button id="saveMangaButton" data-manga-title="HOWL'S MOVING CASTLE">
    ...
    @livewire('comment-component', ['mangaId' => 15])
