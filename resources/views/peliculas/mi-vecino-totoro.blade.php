...
<head>
    ...
    <title>MI VECINO TOTORO - ANIMEDJ</title>
...
<body>
    ...
    <main>
        <section id="anime-info">
            ...
            <img src="https://pics.filmaffinity.com/Mi_vecino_Totoro-520484169-large.jpg" alt="MI VECINO TOTORO" loading="lazy">
            <p>"Mi vecino Totoro" narra la historia de dos hermanas que se mudan al campo para estar cerca del hospital donde su madre se recupera. En su nuevo hogar descubren criaturas mágicas del bosque, entre ellas Totoro, un espíritu amable que les muestra la belleza y los misterios de la naturaleza.</p>

            <div id="anime-player">
                <h3>Reproductor de Episodios</h3>
                <iframe width="640" height="480" src="https://drive.google.com/file/d/1kIVJZaPTW8k0mnQzNg61A0eIGnoqg6rJ/preview" 
                        frameborder="0" allow="autoplay" allowfullscreen loading="lazy"></iframe>
            </div>
        </section>

        <button id="saveMangaButton" data-manga-title="MI VECINO TOTORO">
    ...
    @livewire('comment-component', ['mangaId' => 12])
